"""
Records state-image pairs for Koch robot.

Useful for training encoder and decoder for state space.
E.g. translate the robot DOF to x,y coordinates for push T, or caching actions for IK and FK.
"""
